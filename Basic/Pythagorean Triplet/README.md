<h2><a href="https://practice.geeksforgeeks.org/problems/pythagorean-triplet3018/1?page=6&category[]=Data%20Structures&sortBy=submissions">Pythagorean Triplet</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr</strong> of <strong>N</strong> integers, write a function that returns true if there is a triplet (a, b, c) that satisfies <strong>a<sup>2</sup>&nbsp;+ b<sup>2</sup>&nbsp;= c<sup>2</sup></strong>, otherwise false.</span></p>
